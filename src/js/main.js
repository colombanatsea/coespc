...
function initCmsContent() {
  // Court-circuit : si aucun element ne reference le CMS, ne charge pas js-yaml
  if (!document.querySelector('[data-cms],[data-cms-html],[data-cms-href],[data-cms-src],[data-cms-list]')) {
    return;
  }
